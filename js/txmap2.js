...
$.ajax({
    ...
    error: function (err) {
        ...
        // 可以在这里设置默认信息
        document.getElementById("welcome-info").innerHTML = '<b>欢迎访问本站！</b>';
    }
});
...
function showWelcome() {
    ...
    if (!ipLoacation || !ipLoacation.result) {
        console.warn('IP定位数据未准备好');
        return;
    }

    let dist = getDistance(113.34499552, 23.15537143, ipLoacation.result.location.lng, ipLoacation.result.location.lat);
